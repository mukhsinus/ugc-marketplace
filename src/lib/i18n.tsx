...
const translations: Record<string, Record<Language, string>> = {
  ...
  // Creators Page
  "creators.title": { en: "Creator Marketplace", ru: "Маркетплейс Креаторов", uz: "Kreator Marketplace" },
  "creators.subtitle": { en: "Find the perfect UGC creator for your brand", ru: "Найдите идеального UGC креатора для вашего бренда", uz: "Brendingiz uchun mukammal UGC kreatorni toping" },
  "creators.search": { en: "Search creators...", ru: "Поиск креаторов...", uz: "Kreatorlarni qidirish..." },
  "creators.category.all": { en: "All", ru: "Все", uz: "Barchasi" },
  "creators.category.beauty": { en: "beauty", ru: "красота", uz: "go'zallik" },
  "creators.category.fashion": { en: "fashion", ru: "мода", uz: "moda" },
  "creators.category.food": { en: "food", ru: "еда", uz: "ovqat" },
  "creators.category.tech": { en: "tech", ru: "технологии", uz: "texnologiya" },
  "creators.category.lifestyle": { en: "lifestyle", ru: "образ жизни", uz: "hayot tarzi" },
  "creators.category.fitness": { en: "fitness", ru: "фитнес", uz: "fitness" },
  "creators.category.education": { en: "education", ru: "образование", uz: "ta'lim" },
  "creators.category.travel": { en: "travel", ru: "путешествия", uz: "sayohat" },
  "creators.city.all": { en: "All", ru: "Все", uz: "Barchasi" },
  "creators.city.tashkent": { en: "Tashkent", ru: "Ташкент", uz: "Toshkent" },
  "creators.city.samarkand": { en: "Samarkand", ru: "Самарканд", uz: "Samarqand" },
  "creators.city.bukhara": { en: "Bukhara", ru: "Бухара", uz: "Buxoro" },
  "creators.city.namangan": { en: "Namangan", ru: "Наманган", uz: "Namangan" },
  "creators.city.andijan": { en: "Andijan", ru: "Андижан", uz: "Andijon" },
  "creators.city.fergana": { en: "Fergana", ru: "Фергона", uz: "Farg'ona" },
  "creators.sort.toprated": { en: "Top Rated", ru: "Лучшие оценки", uz: "Eng Yaxshi Baholangan" },
  "creators.sort.pricelow": { en: "Price: Low", ru: "Цена: Низкая", uz: "Narx: Kam" },
  "creators.sort.pricehigh": { en: "Price: High", ru: "Цена: Высокая", uz: "Narx: Ko'p" },
  "creators.sort.newest": { en: "Newest", ru: "Новые", uz: "Yangi" },
  "creators.loading": { en: "Loading creators...", ru: "Загрузка креаторов...", uz: "Kreatorlar yuklanmoqda..." },
  "creators.nodata": { en: "No creators found.", ru: "Креаторы не найдены.", uz: "Kreatorlar topilmadi." },
  "creators.default": { en: "UGC Creator", ru: "UGC Креатор", uz: "UGC Kreator" },
  "creators.rating.new": { en: "New", ru: "Новый", uz: "Yangi" },
  "creators.price": { en: "from $", ru: "от $", uz: "dan $" },
  // Jobs Page
  "jobs.title": { en: "Job Board", ru: "Доска Работ", uz: "Ish Taxtasi" },
  "jobs.subtitle": { en: "Browse UGC campaigns from top brands", ru: "Просмотрите UGC кампании от топ-брендов", uz: "Top brendlarning UGC kampaniyalarini ko'ring" },
  "jobs.loading": { en: "Loading jobs...", ru: "Загрузка работ...", uz: "Ishlar yuklanmoqda..." },
  "jobs.status.open": { en: "Open", ru: "Открыто", uz: "Ochiq" },
  "jobs.status.in_progress": { en: "In Progress", ru: "В процессе", uz: "Jarayonda" },
  "jobs.status.completed": { en: "Completed", ru: "Завершено", uz: "Tugatilgan" },
  "jobs.status.cancelled": { en: "Cancelled", ru: "Отменено", uz: "Bekor qilingan" },
  "jobs.brand.default": { en: "Brand", ru: "Бренд", uz: "Brend" },
  "jobs.videos": { en: "videos", ru: "видео", uz: "video" },
  "jobs.nodata": { en: "No open jobs at the moment. Check back later!", ru: "На данный момент нет открытых работ. Проверьте позже!", uz: "Hozirda ochiq ishlar yo'q. Keyinroq qaytib ko'ring!" },
  // Library Page
  "library.title": { en: "Content Library", ru: "Библиотека Контента", uz: "Kontent Kutubxonasi" },
  "library.subtitle": { en: "Browse and purchase ready-made UGC videos", ru: "Просмотрите и купите готовые UGC видео", uz: "Tayyor UGC videolarni ko'ring va sotib oling" },
  "library.category.all": { en: "All", ru: "Все", uz: "Barchasi" },
  "library.category.beauty": { en: "beauty", ru: "красота", uz: "go'zallik" },
  "library.category.fashion": { en: "fashion", ru: "мода", uz: "moda" },
  "library.category.food": { en: "food", ru: "еда", uz: "ovqat" },
  "library.category.tech": { en: "tech", ru: "технологии", uz: "texnologiya" },
  "library.category.lifestyle": { en: "lifestyle", ru: "образ жизни", uz: "hayot tarzi" },
  "library.category.fitness": { en: "fitness", ru: "фитнес", uz: "fitness" },
  "library.category.education": { en: "education", ru: "образование", uz: "ta'lim" },
  "library.category.travel": { en: "travel", ru: "путешествия", uz: "sayohat" },
  "library.loading": { en: "Loading content...", ru: "Загрузка контента...", uz: "Kontent yuklanmoqda..." },
  "library.creator.default": { en: "Creator", ru: "Креатор", uz: "Kreator" },
  "library.purchase": { en: "Purchase", ru: "Купить", uz: "Sotib olish" },
  "library.nodata": { en: "No content available yet.", ru: "Контент еще не доступен.", uz: "Kontent hali mavjud emas." },
  // Auth
