// src/pages/dashboard/BrandJobs.tsx
...
const BrandJobs = () => {
  ...
  const brandJobs = jobs?.filter(j => j.brand_id === profile?.id) || [];
  ...
  const createJob = () => {
    ...
    if (activeJobs.length >= 10) {
      toast.error("Maximum 10 active jobs allowed");
      return;
    }
    ...
    createJobMutation.mutate(
      {
        ...
        videos_required: Number(form.videos_required) || 1,
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-3 gap-4">
                ...
                <div>
                  ...
                  <Input
                    type="number"
                    value={form.videos_required}
                    onChange={(e) =>
                      setForm({
                        ...form,
                        videos_required: e.target.value
                      })
                    }
                    className="mt-1"
                  />
